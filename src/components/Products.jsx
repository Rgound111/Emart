  ...
  return (
    <div className='py-10'>
      <div className='flex items-center flex-col gap-6'>
        <h1 className='py-2 bg-black w-80 text-white text-center text-2xl rounded-sm uppercase'>
          Shop Everyday
        </h1>
        <span className='h-[2px] bg-black w-32'></span>
        <p className='max-w-[700px] text-gray-500 text-center px-4'>
      ...
      <div className='max-w-screen-xl mx-auto text-gray-700 py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4'>
        {products?.map((item) => (
